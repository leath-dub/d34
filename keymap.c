...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    ...
    [1] = LAYOUT(
        ...
        KC_LALT, KC_LSFT, KC_LCTL, KC_RGUI, XXXXXXX,    KC_GRV,  KC_UNDS, KC_LPRN, KC_RPRN, XXXXXXX,
    ...
    [2] = LAYOUT(
        ...
        KC_PIPE, KC_LCBR, KC_RCBR, KC_MINS, KC_BSLS,    XXXXXXX, KC_RGUI, KC_LCTL, KC_LSFT, KC_LALT,
