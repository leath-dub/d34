...
const uint16_t PROGMEM cmb_normal_mode[] = {KC_J, KC_K, KC_L, COMBO_END};
...
combo_t key_combos[COMBO_COUNT] = {
    ...
    COMBO(cmb_normal_mode, TO(NORMAL_MODE))
    // COMBO(cmb_nav, TG(8)),
    // COMBO(cmb_ext, TG(8))
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    ...
    [1] = LAYOUT(
        TG(3),   CTL_W,   XXXXXXX, XXXXXXX, XXXXXXX,    KC_QUOT, KC_HASH, KC_DLR,  KC_AT,   KC_CIRC,
    ...
    [8] = LAYOUT(
        XXXXXXX, XXXXXXX, KC_E,    KC_R,    XXXXXXX,    XXXXXXX, XXXXXXX, TG(8),   XXXXXXX, XXXXXXX,
